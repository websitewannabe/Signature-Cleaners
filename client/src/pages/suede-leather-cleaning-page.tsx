              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="ml-3 text-neutral-600">
                    Expert cleaning of leather jackets and coats
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="ml-3 text-neutral-600">
                    Specialized suede garment treatment
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
            ...
            <div className="bg-neutral-100 rounded-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Leather Jacket</span>
                  <span className="font-semibold">$75.00+</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Suede Coat</span>
                  <span className="font-semibold">$85.00+</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Leather Pants</span>
                  <span className="font-semibold">$65.00+</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Leather Accessories</span>
      ...
      <section className="relative py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to restore your leather and suede items?
          </h2>
          <Link href="/schedule">
            <Button
              size="lg"
