...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-lg md:text-xl text-white text-opacity-90">
              Quality garment care with convenient pickup and delivery options throughout the city.
            </p>
      ...
      <section id="services" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900">Our Services</h2>
            <p className="mt-4 text-xl text-neutral-600 max-w-3xl mx-auto">
              We provide a range of professional cleaning services to keep your garments looking their best.
            </p>
          </div>
          ...
          {isLoadingServices ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services && services.map((service) => (
                <div key={service.id} className="bg-neutral-50 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
      ...
      <section className="py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-xl text-neutral-600 max-w-3xl mx-auto">
              Our convenient process makes it easy to get your clothes cleaned without disrupting your schedule.
            </p>
          </div>
      ...
      <section id="testimonials" className="py-16 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
