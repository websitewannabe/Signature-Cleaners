      ...
      <main className="flex-grow bg-white py-24 mt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="prose prose-slate max-w-none">
            <h2 className="text-2xl font-semibold mt-8 mb-4">Declaration of Accessibility Introduction</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">Using the EqualWeb website accessibility tool</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">How does the site's accessibility work?</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">Available Accessibility Features</h2>
