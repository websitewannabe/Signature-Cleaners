...
export default function DryCleaningPage() {
  ...
  const services = [
    ...
    {
      name: 'Dresses',
      details: "Delicate care for all dress types, from casual to formal wear, ensuring fabric integrity and perfect finish."
    },
    {
      name: 'Shirts',
      details: "Professional laundering with optional starch levels, precise pressing, and careful attention to collars and cuffs."
    },
    {
      name: 'Pants',
      details: "Thorough cleaning and precise pressing for all types of pants, ensuring perfect creases and wrinkle-free results."
    }
  ];
