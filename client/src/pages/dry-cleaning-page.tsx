            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-6 mt-8 mb-8">
                {[
                  {
                    title: "Suits",
                    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 4h3a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h3m6 0v2H9V4m6 0a2 2 0 012-2h1a2 2 0 012 2v2H9V4a2 2 0 012-2h1a2 2 0 012 2v0z" />,
                    details: "We offer expert cleaning and pressing for business suits, maintaining structure and color while eliminating tough stains."
                  },
                  {
                    title: "Dresses",
                    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 7h10v10M7 17l5-5m0 0l5-5" />,
                    details: "From delicate evening gowns to casual wear, we use gentle processes that preserve shape, color, and detail."
                  },
                  {
                    title: "Shirts",
                    ...
                    details: "Our shirt service includes collar treatment, hand finishing, and optional starch levels to meet your preferences."
                  },
                  {
                    title: "Pants",
                    icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7" />,
                    details: "Crisp creases and stain-free finishes are guaranteed with our tailored approach to cleaning and pressing trousers."
                  }
                ].map((service, index) => {
                  ...
                  return (
                    <div key={index} className="text-center">
                      ...
                      >
                        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto transition-transform duration-300 hover:scale-105">
                          <svg className="w-12 h-12 text-[#790003]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            {service.icon}
                          </svg>
                        </div>
                        <span className="block mt-2 text-sm text-white/90">{service.title}</span>
                      </button>
                      <div className={`overflow-hidden transition-all duration-300 ${isOpen ? 'max-h-48 opacity-100 mt-4' : 'max-h-0 opacity-0'}`}>
                        <div className="bg-neutral-100 p-4 rounded-lg shadow-md">
                          <p className="text-sm text-neutral-700">{service.details}</p>
                        </div>
                      </div>
                    </div>
                  );
