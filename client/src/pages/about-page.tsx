  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-primary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white">About Signature Cleaners</h1>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-neutral-600">
                Since 2005, Signature Cleaners has been providing premium dry cleaning and laundry services with a commitment to quality, sustainability, and customer satisfaction.
              </p>
              <p className="mt-4 text-lg text-neutral-600">
                Founded by the Thompson family with over 30 years of experience in the garment care industry, we've built our reputation on exceptional service and meticulous attention to detail.
              </p>
              <p className="mt-4 text-lg text-neutral-600">
                Our team of experienced professionals uses state-of-the-art equipment and eco-friendly cleaning methods to ensure your garments receive the best possible care.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-neutral-600 max-w-3xl mx-auto">
              At Signature Cleaners, we're guided by a set of core principles that define our approach to garment care.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-neutral-600">
                We never compromise on quality. Every garment receives personalized attention to ensure it's returned to you in perfect condition.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-neutral-600">
                We use eco-friendly cleaning methods and products to minimize our environmental footprint while delivering exceptional results.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-neutral-600">
                We design our services around your busy schedule with convenient pickup and delivery options, online scheduling, and responsive customer service.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral-900">Our Cleaning Process</h2>
            <p className="mt-4 text-lg text-neutral-600 max-w-3xl mx-auto">
              Each garment goes through a meticulous multi-step process to ensure the highest quality results.
            </p>
          </div>
      ...
      <section className="py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral-900">Our Leadership Team</h2>
            <p className="mt-4 text-lg text-neutral-600 max-w-3xl mx-auto">
              Meet the experienced professionals behind our commitment to excellence.
            </p>
          </div>
      ...
      <section className="bg-primary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Experience the Signature Cleaners Difference</h2>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link href="/schedule">
              <Button size="lg" className="w-full sm:w-auto bg-[#F9A826] hover:bg-[#E89212] text-white">
                Schedule a Pickup
              </Button>
            </Link>
            <Link href="/contact">
