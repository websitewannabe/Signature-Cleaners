              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="ml-3 text-neutral-600">
                    Full sole and heel replacement
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
            ...
            <div className="bg-neutral-100 rounded-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Heel Replacement</span>
                ...
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Leather Restoration</span>
                  <span className="font-semibold">From $35.99</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Shoe Stretching</span>
      ...
      <section className="relative py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to give your shoes a new life?
          </h2>
          <Link href="/schedule">
            <Button
              size="lg"
