...
export default function DoylestownDryCleanersPage() {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Doylestown Dry Cleaners | Signature Cleaners</title>
        <meta
          name="description"
          content="Signature Cleaners in Doylestown, PA - Professional dry cleaning services with free pickup and delivery."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-6 text-xl text-white/90 max-w-3xl mx-auto">
              Professional dry cleaning services with convenient pickup and delivery in Doylestown, PA
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 mb-6">
                Visit our location at 1456 Ferry Rd UNIT 100, Doylestown, PA 18901 for all your dry cleaning needs.
              </p>
