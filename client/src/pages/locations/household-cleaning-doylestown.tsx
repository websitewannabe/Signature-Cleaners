      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-neutral-600 max-w-3xl mx-auto">
              Convenient household cleaning services at our Ferry Road location
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">Our Doylestown Home</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">1456 Ferry Rd UNIT 100<br />Doylestown, PA 18901</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">Monday - Friday: 7:00 AM - 7:00 PM<br />Saturday: 8:00 AM - 5:00 PM<br />Sunday: Closed</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">Phone: (215) 345-1470<br />Email: info@mysignaturecleaners.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold">Household Item Drop-Off</h4>
                    <p className="text-neutral-600">We recommend calling ahead for large household items to ensure we have proper handling equipment ready for your arrival.</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left text-neutral-900">
