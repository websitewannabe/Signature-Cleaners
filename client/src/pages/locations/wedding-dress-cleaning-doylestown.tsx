...
export default function WeddingDressCleaningDoylestownPage() {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Wedding Dress Cleaning & Preservation in Doylestown | Signature Cleaners</title>
        <meta
          name="description"
          content="Professional wedding dress cleaning and preservation services in Doylestown, PA. Preserve your special memories with expert care."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-white">
              Wedding Dress Cleaning & Preservation in Doylestown
            </h1>
            <p className="mt-6 text-xl text-white/90 max-w-3xl mx-auto">
              Expert care for your treasured wedding gown
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 mb-6">
                Our Doylestown specialists provide meticulous cleaning and preservation services for wedding gowns. Visit us at 1456 Ferry Rd UNIT 100, Doylestown, PA 18901 or schedule a consultation.
              </p>
