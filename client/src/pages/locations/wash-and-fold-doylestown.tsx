  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional wash and fold laundry service in Doylestown, PA. We handle all your laundry needs with care and convenience."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-white">
              Wash & Fold Laundry in Doylestown
            </h1>
            <p className="mt-6 text-xl text-white/90 max-w-3xl mx-auto">
              Let us handle your laundry with professional care and convenience
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 mb-6">
                Our Doylestown location offers expert wash and fold services for all your laundry needs. Visit us at 1456 Ferry Rd UNIT 100, Doylestown, PA 18901 or schedule a convenient pickup.
              </p>
