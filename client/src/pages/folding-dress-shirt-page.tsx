          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-neutral-600 mb-6">
                Our professional dress shirt service ensures your shirts look crisp, clean, and professionally finished. Each shirt receives individual attention with our specialized process.
              </p>
            ...
            <div className="bg-neutral-100 rounded-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Standard Dress Shirt</span>
                  <span className="font-semibold">$3.99</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Premium Dress Shirt</span>
                  <span className="font-semibold">$4.99</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Heavy Starch</span>
                  <span className="font-semibold">+$1.00</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-neutral-200">
                  <span className="text-neutral-600">Box Packaging</span>
      ...
      <section className="relative py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to experience premium shirt care?
          </h2>
          <Link href="/schedule">
            <Button
              size="lg"
