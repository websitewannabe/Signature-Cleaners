...
export default function TestimonialCarousel() {
  ...
  const [reviewCount, setReviewCount] = useState(448);
              ...
              <div className="mb-4 flex-1">
                ...
                {isLong && (
                  <button
                    ...
                    className="mt-2 cursor-pointer text-xs uppercase tracking-wide text-primary transition-colors hover:text-primary-light"
                  >
